...
public class TargetX : MonoBehaviour
{
    ...
    private float loseValueRate = 0.5f;
    ...
    {
        if (gameManagerX.gameState == GameManagerX.GameState.inGame)
        {
            Explode();
            Destroy(gameObject);
            gameManagerX.UpdateScoreText(pointValue);
            //ShowValue();
        }
    }
    ...
    void ShowValue()
    {
        //valueText.text = pointValue + "";
        //Instantiate(valueText, transform.position + offset);
    }
}
